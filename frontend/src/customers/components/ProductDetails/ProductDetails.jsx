        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                    ...
                    lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className='flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6'>
                                ...
                                <p className='text-green-600 font-semibold'>{products.product?.descountPersent}</p>
                            </div>
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleAddToCart} className='bg-[#9155fd] px-4 py-2 mt-2 rounded-lg hover:bg-indigo-900'>
                                    Add to Card
                                </Button>
                ...
                <section>
                    ...
                    <div className='border p-5'>
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                <h1 className='text-xl font-semibold bp-1'>Product Ratings</h1>
                                ...
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2} >
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", color:"yellow" , borderRadius: 4, height: 7 }} variant='determinate' value={25}  />
                                        </Grid>
                                    </Grid>
                ...
                <section className="pt-10">
                    ...
                    <div className='flex flex-wrap space-y-5 mb-6'>
